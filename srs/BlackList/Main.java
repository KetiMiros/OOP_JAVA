...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    class AbstractPhone {
       ...
       * скрывается от пользователя, а для работы с объектом предоставляется открытый
       * интерфейс.
       */
      /**
       * нам нужно дать пользователю только возможность работы с программой, а не
       * возможность её редактирования
       */
      /**
       * это возможно при использовании модификаторов доступа private, protected,
       * public, а также default
       */
    }
    ...
    class User {
      ...
      public void callAnotherUser(int number, AbstractPhone phone) {
        // вот он полиморфизм - использование в коде абстактного типа AbstractPhone
        // phone!
        phone.call(number);
      }
    }
