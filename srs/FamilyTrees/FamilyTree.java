...
public class FamilyTree implements Serializable {
  ...
  /**
   * Проверяет есть ли у родителя нужный ребенок, если нет, добавляет его в
   * список.
   *
   * @param parent
   * @param child
   ...
   * @return объект Human, представляющий найденного человека, или null, если
   *         человек не найден
   */
  public Human getPersonFromTree(String personName, int yearOfBirth) {
    Year temp = Year.of(yearOfBirth);
    Optional<Human> result = familyTree.stream()
